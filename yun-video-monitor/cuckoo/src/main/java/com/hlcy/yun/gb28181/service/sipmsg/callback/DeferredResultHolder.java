...
public final class DeferredResultHolder {
    ...
    public static final String CALLBACK_CMD_IFRAME = "Callback_Iframe:";

    public static final String CALLBACK_CMD_TELE_BOOT = "Callback_TeleBoot:";

    public static final String CALLBACK_CMD_CRUISE = "Callback_Cruise:";

    public static final String CALLBACK_CMD_FI = "Callback_Fi:";

    public static final String CALLBACK_CMD_SWITCH = "Callback_Switch:";
