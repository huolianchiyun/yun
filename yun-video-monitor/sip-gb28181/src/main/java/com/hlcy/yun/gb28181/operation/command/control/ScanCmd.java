...
import com.hlcy.yun.gb28181.operation.params.ScanParams;
...
public class ScanCmd extends AbstractControlCmd<ScanParams> {
    ...
    private String buildScanCmd(ScanParams params) {
        final StringBuilder builder = getBit123CmdTemplate();

        final ScanParams.ScanType type = params.getType();
        // 字节4
        ...
        // 字节7
        int bit7 = type == ScanParams.ScanType.SET_AUTO_SCAN_SPEED ? params.getScanSpeed() : 0x00;
