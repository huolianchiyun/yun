...
public class SIPClientTransactionImpl extends SIPTransactionImpl implements SIPClientTransaction {
  ...
  /**
   * @see gov.nist.javax.sip.stack.SIPClientTransaction#processResponse(SIPResponse,
   *      MessageChannel, gov.nist.javax.sip.stack.SIPDialog)
   */
  @Override
  ...
  public void sendRequest() throws SipException {
    ...
    try {
          ...
          && expiresTimerTask == null)
      {
        ...
        sipStack.getTimer().schedule(expiresTimerTask, (long) expiresTime * 1000L);
  ...
  public Request createCancel() throws SipException {
    ...
    if (!originalRequest.getMethod().equals(Request.INVITE)) {
      throw new SipException("Only Invite may be cancelled");
    }
  ...
  public Request createAck() throws SipException {
    ...
    if (!((SipURI) ((Route) routeList.getFirst()).getAddress().getURI()).hasLrParam()) {
      ...
      if (contact != null) {
        route = new Route();
        route.setAddress((AddressImpl) contact.getAddress().clone());
      }
  ...
  /**
   * @see gov.nist.javax.sip.stack.SIPClientTransaction#setViaHost(String)
   */
  @Override
  ...
  /**
   * @see gov.nist.javax.sip.stack.SIPClientTransaction#checkFromTag(SIPResponse)
   */
  @Override
   ...
   */
  /**
   * @see gov.nist.javax.sip.stack.SIPClientTransaction#getDialog(String)
   */
  @Override
  ...
  /**
   * @see gov.nist.javax.sip.stack.SIPClientTransaction#setNextHop(Hop)
   */
  @Override
