package com.yun.monitor.admin.server.notify.config;

import com.yun.monitor.admin.server.notify.dingtalk.DingTalkNotifier;
import com.yun.monitor.admin.server.notify.dingtalk.DingtalkProperties;
import com.yun.monitor.admin.server.notify.sms.SMSNotifier;
