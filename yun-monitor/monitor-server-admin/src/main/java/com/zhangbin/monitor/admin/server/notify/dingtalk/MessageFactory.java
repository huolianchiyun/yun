...
import com.zhangbin.monitor.admin.server.notify.dingtalk.message.LinkMessage;
import com.zhangbin.monitor.admin.server.notify.dingtalk.message.MarkdownMessage;
import com.zhangbin.monitor.admin.server.notify.dingtalk.message.MsgType;
import com.zhangbin.monitor.admin.server.notify.dingtalk.message.TextMessage;
