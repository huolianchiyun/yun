package com.yun.sys.modules.logging.aspect;

import com.yun.sys.modules.logging.service.LogService;
import com.yun.common.utils.ip.IPUtil;
import com.yun.common.spring.RequestHolder;
import com.yun.common.exception.ThrowableUtil;
import static com.yun.sys.modules.logging.enums.LogLevel.*;
...
public final class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.yun.sys.modules.logging.annotation.Logging)")
